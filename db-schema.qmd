...
tribble(
  ...
  "dist_to_coast",           "REAL",       "",   "",    TRUE,          "Distance to the nearest coastline (km). Reserved but EMPTY: filled at the clean stage.", "",
  "est_country",             "TEXT",       "",   "",    TRUE,          "Nearest country. Reserved but EMPTY: filled at the clean stage.",                        "",
  "country_code",            "TEXT",       "",   "",    TRUE,          "ISO 3166-1 alpha-3 code of the nearest country (e.g. DEU). Reserved but EMPTY: filled at the clean stage.", "",
  "municipality",            "TEXT",       "",   "",    TRUE,          "Nearest municipality, Europe only. Reserved but EMPTY: filled at the clean stage.", "",
  "sea_name",                "TEXT",       "",   "",    TRUE,          "Sea or ocean name. Reserved but EMPTY: filled at the clean stage.",                   ""
)
```
