...
`main` holds releases, `develop` is the integration branch, and work happens on
`feature/*` / `release/*` branches. Branches are merged directly (no pull
requests) and deleted once merged.
